...
void INT1_ISR(void)
{
    ...
    /* ocorreu interrupção do botao de MENU*/
    LATCbits.LATC5 = 1; //LIGA LED DE SINALIZAÇÃO
    /*menu_var vai a 1 -> para ativar a funçao*/
    menu_var = 1;
...
void INT0_ISR(void)
{
    ...
    /* ocorreu interrupção do botao de MENU*/
    LATCbits.LATC5 = 1; //LIGA LED DE SINALIZAÇÃO
    /*verifica se a var esta a 1 ou a o*/
    if (emergencia_var == 0) {

        /*emergencia_var vai a 1, ativa a emergencia*/
        emergencia_var = 1;

    } else emergencia_var = 0; /*emergencia_var vai a 0, desativa a emergencia*/
